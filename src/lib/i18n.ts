...
export const i18n = {
  cyrl: {
    ...
    founder: {
      ...
      bio: "Мен — Бахтиёр, Сурхондарёданман. Дастурчиман ва IT ўқув маркази асосчисиман. Чорва олди-соттисида одамлар алданаётганини кўриб, буни тартибга солиш учун платформа қуряпман.",
    ...
    thankYou: {
      ...
      questions: {
        ...
        q4Options: [
          "Сотувчига ишониш (пулга куйиш)",
          "Ҳақиқий нархни билмаслик (қиммат олиш, арзон сотиш)",
          "Зотдор чорва тополмаслик",
          "Танлов камлиги",
          "Транспорт ва етказиб бериш",
          "Соғлигини билмаслик ( касал ҳайвон сотиб олиш)",
        ],
        ...
        q6Title: "Қайси бири устида кўпроқ ишлашимиз керак?",
        q6Options: [
          "Платформа қулайлиги",
          "Танловлар кўплиги",
          "Ҳар бир чорвани текшириб жойлаш",
          "Тезкор қидирув",
          "Транспорт ва етказиб бериш",
          "Ветеринар ҳужжат",
        ],
